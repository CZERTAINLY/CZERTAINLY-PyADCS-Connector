...
from PyADCSConnector.utils.crmf import CertReqMsg, CertificationRequestNullSigned, CertReqMessages
...
class CmsTest(TestCase):
    ...
    def test_cms(self):
        ...
        signer_info['sid'] = cms.SignerIdentifier(
            {'issuer_and_serial_number': {
                'issuer': Name.build({'organization_name': '3Key Company s.r.o.', 'common_name': 'DemoClientSubCA_2307RSA',}),
