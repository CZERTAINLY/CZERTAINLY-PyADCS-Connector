...
SELECT_CA_METHOD_ATTRIBUTE_NAME = "select_ca_method"
SELECT_CA_METHOD_ATTRIBUTE_UUID = "ad5e1ca6-a018-43b3-8d36-17a1deb61cb8"
SELECT_CA_METHOD_ATTRIBUTE_LABEL = "Select CA Method"
SELECT_CA_METHOD_ATTRIBUTE_DESCRIPTION = "Select how the CA will be chosen, either by ComputerName or search"

# ComputerName Attribute
CONFIGSTRING_ATTRIBUTE_NAME = "config_string"
CONFIGSTRING_ATTRIBUTE_UUID = "ab4f8573-bf55-4863-b2ce-44597b111cf9"
CONFIGSTRING_ATTRIBUTE_LABEL = "CA ConfigString"
CONFIGSTRING_ATTRIBUTE_DESCRIPTION = "ConfigString of the CA"

# CA Select Group Attribute
CA_SELECT_GROUP_ATTRIBUTE_NAME = "ca_select_group"
CA_SELECT_GROUP_ATTRIBUTE_UUID = "b5cd936c-5375-48d9-bd34-4e859195f1af"
CA_SELECT_GROUP_ATTRIBUTE_LABEL = "CA Select Group Attribute"
CA_SELECT_GROUP_ATTRIBUTE_DESCRIPTION = "For identification of select CA method"

# CA Select Group on RA Profile Attribute
CA_SELECT_GROUP_RA_PROFILE_ATTRIBUTE_NAME = "ca_select_group_ra_profile"
CA_SELECT_GROUP_RA_PROFILE_ATTRIBUTE_UUID = "95e66931-46f1-4a5d-8989-455c1f10eb5e"
CA_SELECT_GROUP_RA_PROFILE_ATTRIBUTE_LABEL = "CA Select Group Attribute"
CA_SELECT_GROUP_RA_PROFILE_ATTRIBUTE_DESCRIPTION = "For identification of select CA method"

# Authority UUID Attribute
AUTHORITY_UUID_ATTRIBUTE_NAME = "authority_uuid"
AUTHORITY_UUID_ATTRIBUTE_UUID = "8c4c213a-9bd4-4d49-9812-a539a2deac16"
AUTHORITY_UUID_ATTRIBUTE_LABEL = "Authority UUID"
AUTHORITY_UUID_ATTRIBUTE_DESCRIPTION = "UUID of selected authority"
