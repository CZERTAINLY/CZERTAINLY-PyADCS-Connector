...
from asn1crypto.core import OctetBitString, ParsableOctetString, SequenceOf, OctetString, Null
...
""" Creation of CMS 'by hand' for future reference"""
...
def test_cms():
    ...
    crmf_CertReqMsg = CertReqMessages.load(base64.b64decode(crmf_encoded))[0]
    ...
    extension['extn_value'] = 'WebServer'
    ...
    signer_info['sid'] = cms.SignerIdentifier(
        {'issuer_and_serial_number': {
            'issuer': Name.build(
                {'organization_name': '3Key Company s.r.o.', 'common_name': 'DemoClientSubCA_2307RSA', }),
            'serial_number': 576151116702806353914926698083502104585008145929}})
